...
| `discharge/` | Discharge Tracker | Advise-to-out clock for inpatient discharges — each hand-off (summary → pharmacy → bill → TPA → settlement → bed vacated) tapped done by the desk that owns it, per-step and total targets (3¾ h cash / 5¾ h insured), ward view of beds freeing up, step-bottleneck and bed-release-by-hour trends |
